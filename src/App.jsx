...
const App = () => {
  ...
  const apiKey = import.meta.env.VITE_OMDB_API_KEY || '3fcc6067';
        ...
        {error && (
          <div className="flex flex-col items-center justify-center py-20 bg-dark-800 rounded-xl p-8">
            ...
            <p className="text-gray-500 text-sm mt-2 text-center">
              <a href="http://www.omdbapi.com/apikey.aspx" target="_blank" rel="noopener noreferrer" className="text-red-400 hover:underline">omdbapi.com</a>
            </p>
          </div>
        )}
